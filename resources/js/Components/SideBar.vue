            ...
            <div class="space-y-8">
                ...
                <div>
                    ...
                    <ul class="mt-3">
                        ...
                        <li class="px-3 py-2 rounded-sm mb-1 last:mb-0"
                            :class="route().current('app.classrooms.*') && 'bg-gray-900'">
                            <Link :href="appRoute('classrooms.index')"
                                  class="block text-gray-200 hover:text-white truncate transition duration-150"
                                  :class="route().current('app.classrooms.*') && 'hover:text-gray-200'">
                                <div class="flex items-center">
                                    <svg class="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                                        <path class="fill-current text-gray-600"
                                                :class="route().current('app.classrooms.*') && 'text-indigo-500'"
                                                d="M19.714 14.7l-7.007 7.007-1.414-1.414 7.007-7.007c-.195-.4-.298-.84-.3-1.286a3 3 0 113 3 2.969 2.969 0 01-1.286-.3z"/>
                                        <path class="fill-current text-gray-400"
                                                :class="route().current('app.classrooms.*') && 'text-indigo-300'"
