<template>
    <div class="relative inline-flex">
        ...
        >
            <img class="w-8 h-8 rounded-full" :src="$page.props.user.profile_photo_url" :alt="$page.props.user.name" width="32" height="32" />
        ...
        >
            <div v-show="dropdownOpen" class="origin-top-right z-10 absolute top-full min-w-44 bg-white border
       border-gray-200 py-1.5 rounded shadow-lg overflow-hidden mt-1" :class="align === 'right' ? 'right-0' : 'left-0'">
                ...
                >
                    <li>
                        <Link :href="route('profile.show')"
                            ...
                            @click="dropdownOpen = false">Profile
                        </Link>
                    </li>
                    <li>
                        <a href="#"
