<template>
    <div class="font-sans leading-normal tracking-normal">
        ...
        <nav id="header" class="bg-gray-800 fixed w-full z-10 top-0 shadow">
            ...
            <div class="w-full container mx-auto flex flex-wrap items-center mt-0 pt-3 pb-3 md:pb-0">
                ...
                <div class="w-1/2 pl-2 md:pl-0">
                    <a class="text-white text-base xl:text-xl no-underline hover:no-underline font-bold" href="#">
                        <i class="fas fa-sun pr-3"></i> EcolSo - Gestion des IEP
                    </a>
                </div>
                <div class="w-1/2 pr-0">
                    <div class="flex relative inline-block float-right">

                        <div class="relative text-sm m-3">
                            <button id="userButton" class="flex items-center focus:outline-none mr-3 text-gray-200">
                                <img class="w-8 h-8 rounded-full mr-4" :src="$page.props.user.profile_photo_url" :alt="$page.props.user.name">
                                <span class="hidden md:inline-block text-sm font-bold">{{ $page.props.user.name }}</span>
                ...
                <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-800 z-20" id="nav-content">
                    <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0 mb-2">
                        <li class="mr-6 my-2 md:my-0">
                            <Link :href="route('dashboard')"
                                class="block text-gray-200 hover:text-white py-1 md:py-3 pl-1 truncate transition duration-150"
                                :class="route().current('dashboard') && 'hover:text-gray-200 border-b-2 border-gray-200'"
                            >
                                <i class="fas fa-home fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Tableau de board</span>
                            </Link>
                        </li>
                        <li class="mr-6 my-2 md:my-0">
                            <Link :href="route('schools.index')"
                                class="block text-gray-200 hover:text-white py-1 md:py-3 pl-1 truncate transition duration-150"
                                :class="route().current('schools.index') && 'hover:text-gray-200 border-b-2 border-gray-200'"
                            >
                        ...
                        <li class="mr-6 my-2 md:my-0">
                            <Link href="#" class="block py-1 md:py-3 pl-1 align-middle text-gray-500 no-underline hover:text-gray-900 border-b-2 border-white hover:border-pink-500">
                                <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Paramètres</span>
                            </Link>
                        </li-->
                    </ul>
        ...
        <div class="container w-full mx-auto pt-20">
            <div class="w-full px-4 md:px-0 mt-20 mb-16 text-gray-800 leading-normal">
                <slot></slot>
            </div>
        </div>
        <!--/container-->
